...
function Index_FAQ() {
    ...
    async function deleteData(id) {
        let result = await fetch("http://127.0.0.1:8000/api/faqs/" + id, {
            method: "DELETE"
        });
        await result.json()
        index()
    ...
    function index() {
        setSpinner(true)
        fetch("http://127.0.0.1:8000/api/faqs").then((result) => {
                            ...
                            spinner ? <tr>
                                ...
                                data.map((data, i) =>
                                    <tr>
                                        ...
                                        <td>
                                            <svg onClick={() => deleteFaq(data.id)} xmlns="http://www.w3.org/2000/svg"
                                                 width="24" height="24"

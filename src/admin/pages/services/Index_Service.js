...
function Index_Service() {
    ...
    async function deleteData(id) {
        let result = await fetch("http://127.0.0.1:8000/api/services/" + id, {
            method: "DELETE"
        });
        await result.json()
        index()
    ...
    function index() {
        setSpinner(true);
        fetch("http://127.0.0.1:8000/api/services").then((result) => {
                                ...
                                data.map((data, i) =>
                                    <tr>
                                        ...
                                        <td><img className="avatar img-fluid rounded-circle"
                                                 src={"http://127.0.0.1:8000/admin/images/services/" + data.picture}
                                                 width="50"/></td>
                                        <td>
                                            <svg onClick={() => deleteService(data.id)}

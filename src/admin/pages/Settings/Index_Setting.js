...
function Index_Setting() {
    ...
    async function deleteData(id) {
        let result = await fetch("http://127.0.0.1:8000/api/settings/" + id, {
            method: "DELETE"
        });
        await result.json()
        index()
    ...
    function index() {
        setSpinner(true)
        fetch("http://127.0.0.1:8000/api/settings").then((result) => {
                            ...
                            spinner ? <tr>
                                ...
                                data.map((data, i) =>
                                    <tr>
                                        ...
                                        <td>
                                            <svg onClick={() => deleteSetting(data.id)}

...
function Index_AboutUs() {
    ...
    async function deleteData(id) {
        let result = await fetch("http://127.0.0.1:8000/api/about-us/" + id, {
            method: "DELETE",
        })
        await result.json();
        index()
    ...
    function index() {
        setSpinner(true)
        fetch("http://127.0.0.1:8000/api/about-us").then((result) => {
                                ...
                                data.map((data, i) =>
                                    <tr>
                                        ...
                                        <td><img className="avatar img-fluid rounded-circle"
                                                 src={"http://127.0.0.1:8000/admin/images/about_us/" + data.icon}
                                                 width="100"/></td>

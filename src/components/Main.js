...
import TestimonalScreen from "../screen/TestimonalScreen";
...
function Main() {
    ...
    useEffect(() => {
        fetch("http://127.0.0.1:8000/api/get-fronted-data").then((result) => {
    ...
    return (
        <>
            ...
            <main id="main">
                <ClientScreen/>
                <AboutScreen about_us={about_us} settings={settings}/>
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active show" id="tab-1">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up"
                                         data-aos-delay="200">
                                        <img src="frontend/assets/img/tabs-1.jpg" alt=""
                                             className="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                                        ...
                                        <ul>
                                            ...
                                            <li><i className="ri-check-double-line"></i> Provident mollitia neque rerum
                                    ...
                                    <div className="col-lg-6 order-1 order-lg-2 text-center">
                                        <img src="frontend/assets/img/tabs-2.jpg" alt=""
                                             className="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane" id="tab-3">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 order-1 order-lg-2 text-center">
                                        <img src="frontend/assets/img/tabs-3.jpg" alt=""
                                             className="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                            <div className="tab-pane" id="tab-4">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 order-1 order-lg-2 text-center">
                                        <img src="frontend/assets/img/tabs-4.jpg" alt=""
                                             className="img-fluid"/>
                                    </div>
                                </div>
                            </div>
                ...
                <ServiceScreen services={services} settings={settings}/>
                <PortfolioScreen portfolios={portfolios} settings={settings}/>
                <TestimonalScreen testimonials={testimonials} settings={settings}/>
                <PricingScreen settings={settings} settings={settings}/>
                <FAQScreen faqs={faqs}/>
                <TeamScreen teams={teams} settings={settings}/>
                <ContactScreen settings={settings} settings={settings}/>
            </main>
            <Footer/>
        </>
    )
